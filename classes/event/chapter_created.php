...
/**
 * mod_ncsubook chapter created event.
 *
...
class chapter_created extends \core\event\base {
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'ncsubook', 'add chapter', 'view.php?id=' . $this->contextinstanceid . '&chapterid=' .
    ...
    public function get_url() {
        return new \moodle_url('/mod/ncsubook/view.php', array(
