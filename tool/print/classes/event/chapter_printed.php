...
class chapter_printed extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has printed the chapter with id '$this->objectid' of the NC State Book with " .
    ...
    public static function get_name() {
        return get_string('eventchapterprinted', 'ncsubooktool_print');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/ncsubook/tool/print/index.php', array('id' => $this->contextinstanceid));
    }
