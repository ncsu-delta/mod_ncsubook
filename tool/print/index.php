...
$PAGE->set_url('/mod/ncsubook/print.php', array('id'=>$id, 'chapterid'=>$chapterid));
...
if ($chapter) {
    ...
    <html>
    <head>
      <title><?php echo format_string($ncsubook->name, true, array('context'=>$context)) ?></title>
      <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
      <meta name="description" content="<?php echo s(format_string($ncsubook->name, true, array('context'=>$context))) ?>" />
      <!-- <link rel="stylesheet" type="text/css" href="print.css" /> -->
    </head>
    <body>
    <a name="top"></a>
    <h1 class="ncsubook_title"><?php echo format_string($ncsubook->name, true, array('context'=>$context)) ?></h1>
    <div class="chapter">
    <?php
    ...
    <head>
      <title><?php echo format_string($ncsubook->name, true, array('context'=>$context)) ?></title>
      <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
      <meta name="description" content="<?php echo s(format_string($ncsubook->name, true, array('noclean'=>true, 'context'=>$context))) ?>" />
      <link rel="stylesheet" type="text/css" href="print.css" />
    </head>
    <body>
    <a name="top"></a>
    <h1 class="ncsubook_title"><?php echo format_string($ncsubook->name, true, array('context'=>$context)) ?></h1>
    <p class="ncsubook_summary"><?php echo format_text($ncsubook->intro, $ncsubook->introformat, array('noclean'=>true, 'context'=>$context)) ?></p>
    ...
    <td><?php echo get_string('modulename', 'mod_ncsubook') ?>:</td>
    <td><?php echo format_string($ncsubook->name, true, array('context'=>$context)) ?></td>
    </tr><tr>
    <td><?php echo get_string('printedby', 'ncsubooktool_print') ?>:</td>
    <td><?php echo fullname($USER, true) ?></td>
    </tr><tr>
    <td><?php echo get_string('printdate', 'ncsubooktool_print') ?>:</td>
    ...
    foreach ($chapters as $ch) {
        $chapter_css_tag = ncsubook_get_chapter_css_tag($ch->id);
        $css_tag_string = 'generalbox ncsubook_content '.$chapter_css_tag;
        echo $OUTPUT->box_start($css_tag_string);
